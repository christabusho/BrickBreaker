...
public abstract class GameObj  {
     ...
     */
    public void bounce(org.cis1200.brickBreaker.Direction d) {
        if (d == null) {
            return;
        }
    ...
    public org.cis1200.brickBreaker.Direction hitWall() {
        ...
        if (this.py + this.vy < 0) {
            ...
            return org.cis1200.brickBreaker.Direction.DOWN;
        } else {
            return null;
        }
    }
     ...
     *         collision.
     */
    public org.cis1200.brickBreaker.Direction hitObj(GameObj that) {
